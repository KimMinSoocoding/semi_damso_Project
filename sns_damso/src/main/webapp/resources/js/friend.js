...
$(document).on("click", "#followerBtn", function() {
	...
	$.ajax({
		type: "GET",
		url: cp + "/friend/select?following=" + following + "&followed=" + followed,
		dataType: "json",
		success: function(data) {
			...
			data.forEach(function(follower) {
				...
				var row = $("<tr></tr>");
				row.append('<td><a href="' + cp + '/member/profile/' + follower.email + '/damso">' + follower.id + '</a></td>');
				row.append('<td><a href="' + cp + '/member/profile/' + follower.email + '/damso" style="color: black">' + follower.name + '</a></td>');				
...
$(document).on("click", "#followingBtn", function() {
	...
	$.ajax({
		type: "GET",
		url: cp + "/friend/selectFriend?following=" + following + "&followed=" + followed,
		dataType: "json",
		success: function(data) {
...
$(document).ready(function() {
	...
	$.ajax({
		url: cp + "/friend/" + emaill + "/followerCount",
		method: "GET",
		dataType : "json",
...
$(document).ready(function() {
	...
	$.ajax({
		url: cp + "/friend/" + emaill + "/followCount",
		method: "GET",
		dataType : "json",
		success: function(response) {
...
$(document).on("click", ".addFriend", function () {
	...
	$.ajax({
		type: "GET",
		url: cp + "/friend/check?following=" + following + "&followed=" + followed,
		dataType: "json",
		success: function(data) {
...
$(document).on("click", ".unfollow-btn", function() {
	...
	$.ajax({
		type: "DELETE",
		url: cp + "/friend/unfollow/" + following + "/" + followed + ".com",
		dataType: "json",
		success: function(data) {
			btn.text("팔로우");
