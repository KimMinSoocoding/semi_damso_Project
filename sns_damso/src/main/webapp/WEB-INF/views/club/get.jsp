				...
				<div class="d-flex club-profile-img" data-cno="${club.cno }" data-img="${club.attaches[0]}">
					...
					<c:if test="${not empty club.attaches[0].uuid}">
  					<img class="thisclub-img info-img"
						...
						src="/display?name=${club.attaches[0]['name']}&path=${club.attaches[0]['path']}&uuid=${club.attaches[0]['uuid']}&image=${club.attaches[0]['image']}&thumb=on"
						alt="Image">	
					</c:if>
					<!-- 프사가 없는 경우 -->
		...
		<div class="modal-dialog modal-dialog-centered modal-lg"
			...
			<div class="modal-content"
				...
				<div class="col-12 d-flex flex-column">
					...
					<div class="col-12 d-flex flex-column" style="height:150px">
