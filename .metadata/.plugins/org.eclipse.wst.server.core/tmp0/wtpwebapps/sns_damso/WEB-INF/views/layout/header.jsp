...
<head>
	...
	<!-- Favicon -->
	<link
			href="${pageContext.request.contextPath }/resources/img/favi.png"
			rel="icon">
...
<div class="position-relative bg-white d-flex p-0">
	...
	<script>
		...
		let aws = new WebSocket("ws://${pageContext.request.serverName}:${pageContext.request.serverPort}/notification")
			...
			$(".noti-list").on("click", "a", function () {
				...
				if (type == "clubRegister") {
					...
					boardService.get($this.data("bno"), function (result) {
						...
						$("#detailImage").attr("src", "/display?name=" + result.attaches[0]['name'] + "&path=" + result.attaches[0]['path'] + "&uuid=" + result.attaches[0]['uuid'] + "&image=" + result.attaches[0]['image'] + "&thumb=on")
